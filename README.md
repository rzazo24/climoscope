...
- Current weather: temperature, feels-like, humidity, wind + gusts (with SVG compass), pressure, UV index, and air quality (European AQI, color-coded by category) — click the air quality number for a detail panel with US AQI and pollutant levels (PM2.5, PM10, NO₂, O₃, SO₂, CO)
- Sunrise and sunset
